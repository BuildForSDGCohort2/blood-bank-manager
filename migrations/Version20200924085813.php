 ...
 */
final class Version20200924085813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blood_product DROP blood_bank_id, DROP quantity');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE blood_product ADD blood_bank_id INT NOT NULL, ADD quantity INT NOT NULL');
